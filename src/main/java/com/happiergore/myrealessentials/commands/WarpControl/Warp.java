...
import com.happiergore.myrealessentials.db.SQLite.WarpsDAO;
import com.happiergore.myrealessentials.db.SQLite.WarpsJBDC;
import static com.happiergore.myrealessentials.helper.TextUtils.errorMsg;
...
public class Warp extends Commands {
    ...
    public void refreshArgList() {
        System.out.println("Warps registered: " + WarpsJBDC.WARPS_REGISTERED.toString());
